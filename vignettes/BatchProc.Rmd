---
title: "randBatch: Randomizing with many Strata"
...
## Vignette for the Package: `randBatch`

This vignette illustrates the functionality of the R-package `randBatch`.  It demonstrates all of the functions within the package.  This document also demonstrates the use of an example pipeline to describe the flow of a randomization for an observational study using the package.
...
```{r testData}
testR <- testRand(rowSize=20,colSize=15,studySize=1000,expNS=7000,numCC=2,QCpct=0.07,child=4)
